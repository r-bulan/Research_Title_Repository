<x-app-layout title="Dashboard">
    <div class="grid auto-rows-min gap-4 md:grid-cols-3">
        ...
        <div class="overflow-hidden rounded-xl border border-neutral-200 p-6 bg-white shadow-sm hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-neutral-600">Total  Research Titles</p>
        ...
        <div class="overflow-hidden rounded-xl border border-neutral-200 p-6 bg-white shadow-sm hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-neutral-600">Active  Research Titles</p>
        ...
        <div class="overflow-hidden rounded-xl border border-neutral-200 p-6 bg-white shadow-sm hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-neutral-600">Trashed  Research Titles</p>
    ...
    <div class="mt-6 rounded-xl border border-neutral-200 p-6 bg-white shadow-sm">
        ...
        <div class="space-y-3 text-sm text-neutral-600">
            <p>📊 <strong>Total Research Titles:</strong> {{ $totalTitles }} titles in the  repository</p>
            ...
            <hr class="my-4">
            <p class="text-xs text-neutral-500"> Research Title Repository</p>
        </div>
    </div>
</x-app-layout>
