<x-app-layout :title="'Add Research Title'">
    <div class="max-w-2xl">
        <form method="POST" action="{{ route('research_titles.store') }}" enctype="multipart/form-data" class="bg-white rounded-lg shadow-sm border border-neutral-200 p-6 space-y-6">
            @csrf
            ...
            <div>
                ...
                <div class="mt-2">
                    ...
                    @error('photo')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    <p class="text-xs text-gray-500 mt-2">Accepted formats: JPG, PNG. Maximum size: 2MB</p>
                </div>
