...
<body>
    ...
    <!-- Footer -->
    <div class="footer">
        <p><strong>CCS Research Title Repository</strong></p>
        <p>File: ccs_research_titles_{{ $exportDate->format('YmdHis') }}.pdf</p>
        <p style="margin-top: 10px; font-size: 9px; color: #999;">
            This document was automatically generated by the CCS Research Title Repository system. 
